...
const { WEATHER_BALL_BY_WEATHER, resolveTypeFor, weatherChangesDamage } = require('./weather_rules');
...
// number is mechanics, not a measurement. weatherChangesDamage()/resolveTypeFor()
// now live in weather_rules.js (imported above), shared with spread_scorer.js
// and team.js so this predicate isn't re-derived a third time.
